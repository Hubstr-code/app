/**
 * Hubstr Skill Server connection status
 */
...
/**
 * Hubstr Skill Tool definition (from Market API)
 */
...
/**
 * Hubstr Skill Provider definition (from Market API)
 */
...
/**
 * Hubstr Skill Server instance (user-connected provider)
 */
...
/**
 * Parameters for calling Hubstr Skill tool
 */
...
/**
 * Result of calling Hubstr Skill tool
 */
