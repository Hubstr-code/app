...
describe('agentSignal feature gates', () => {
  it('recognizes only the inbox builtin slug as Hubstr AI', () => {
  ...
  it('enables Hubstr AI self-iteration when the feature flag is enabled', () => {
    expect(
      resolveAgentSelfIterationCapability({
  ...
  it('keeps non-Hubstr AI agents behind agentSelfIterationEnabled', () => {
    expect(
      resolveAgentSelfIterationCapability({
        agentSelfIterationEnabled: true,
        isAgentSelfIterationFeatureEnabled: true,
