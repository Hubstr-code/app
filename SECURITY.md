...
Please report security vulnerabilities through the GitHub Security Advisory ["Report a Vulnerability"](https://github.com/Hubstr-code/app/security/advisories/new) tab.
...
- Security issues affecting the **latest 2.x release** of Hubstr
- Vulnerabilities in the **server-side deployment** (Hubstr Cloud or self-hosted server mode)
...
- **Primary**: [GitHub Security Advisories](https://github.com/Hubstr-code/app/security/advisories/new)
