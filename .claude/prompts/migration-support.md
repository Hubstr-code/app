...
**IMPORTANT**: The official documentation website is `https://hubstr.com`. When providing documentation links, always use `https://hubstr.com/docs/...` format. Never use `lobechat.com` - that domain is incorrect.

Examples of correct documentation URLs:

- `https://hubstr.com/docs/self-hosting/migration/v2/auth/nextauth-to-betterauth`
- `https://hubstr.com/docs/self-hosting/migration/v2/auth/clerk-to-betterauth`
- `https://hubstr.com/docs/self-hosting/auth`
- `https://hubstr.com/docs/self-hosting/auth/providers/casdoor`
