...
description: Hubstr 新增支持 Gitee AI、InternLM、xAI 和 Cloudflare Workers AI， 为团队提供更多模型接入选择。
tags:
  - Hubstr
  - AI 模型服务
  - Gitee AI
...
还需要其他服务商支持？在 [GitHub Discussions](https://github.com/Hubstr-code/app/discussions/6157) 告诉我们优先支持哪些。
