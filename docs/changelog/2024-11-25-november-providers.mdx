...
description: >-
  Hubstr now supports Gitee AI, InternLM, xAI, and Cloudflare Workers AI,
...
Need additional providers? Tell us which ones to prioritize in [GitHub Discussions](https://github.com/Hubstr-code/app/discussions/6157).
