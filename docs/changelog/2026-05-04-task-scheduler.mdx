...
description: >-
  Delegate Claude Code and Codex from inside Hubstr, with a redesigned home, a
...
- **Delegate Claude Code and Codex.** Control coding agents inside Hubstr: click Create Agent and choose your coding agent. Desktop only.
