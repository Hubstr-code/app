---
title: Build Your Own Hubstr - Choose Your Deployment Platform
description: >-
  Explore multiple deployment platforms like Vercel, Docker, Docker Compose, and
  more to deploy Hubstr. Choose the platform that best suits your needs.
tags:
  - Hubstr
  - Deployment Platform
  - Vercel
...
# Build Your Own Hubstr

Hubstr can be self-hosted on your own infrastructure, giving you complete control over your data, customization, and deployment environment. Whether you're deploying for a team, organization, or personal use, Hubstr supports multiple deployment methods.

<PlatformCards urlPrefix={'platform'} />

## Architecture Overview

Hubstr consists of several key components:
...
Before deploying Hubstr, gather the following:
...
5. **Regular updates** — Keep Hubstr and dependencies up to date
