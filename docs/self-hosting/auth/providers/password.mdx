---
title: Configuring Email/Password Authentication for Hubstr
description: >-
  Learn how to configure email and password authentication for Hubstr,
...
Hubstr supports traditional email and password authentication out of the box.
