---
title: Configuring Auth0 Authentication for Hubstr
description: >-
  Learn how to configure Auth0 SSO for Hubstr, including creating applications,
...
<Steps>
  ...
  <Image alt="Create Auth0 Application S1" inStep src="https://github.com/Hubstr-code/app/assets/30863298/f068190f-0027-4d3b-8667-d632e43d5a86" />

  3. Fill in the application name
  4. Select **Regular Web Applications** as the application type
  5. Click **Create**

  <Image alt="Create Auth0 Application S2" inStep src="https://github.com/Hubstr-code/app/assets/30863298/3e0082df-9b6f-46f3-b67f-bdc79e1eb2cc" />

  ### Configure Application Settings

  After creation, go to the **Settings** tab:

  <Image alt="Create Auth0 Application S3" inStep src="https://github.com/Hubstr-code/app/assets/30863298/df4cea85-616a-46f5-b2de-42725d9b82a6" />
  ...
  <Image alt="Create Auth0 Application S4" inStep src="https://github.com/Hubstr-code/app/assets/30863298/62fbd09f-a69a-4460-949b-0f6285fa65b9" />

  ### Add Users (Optional)

  Click **User Management** to create users for your organization.

  <Image alt="Add Users" inStep src="https://github.com/Hubstr-code/app/assets/30863298/0beda150-d0b6-43cf-a9f1-fce928b83a96" />
...
<Image alt="Connecting to Existing SSO Service" src="https://github.com/Hubstr-code/app/assets/30863298/9891347e-a338-4aa9-8714-f16c8dbcfcec" />

### Configure Social Login

Configure social login in **Authentication** > **Social**.

<Image alt="Configuring Social Login" src="https://github.com/Hubstr-code/app/assets/30863298/880749a6-5ba4-4e20-a968-b583a54de7fa" />
...
<Callout type={'warning'}>
  When creating a GitHub connection, make sure to enable the **Email Address** permission in the **Attributes** section. Hubstr requires user email for authentication.
