---
title: 在 Hubstr 中配置 Microsoft 身份验证
description: >-
  学习如何在 Hubstr 中配置 Microsoft (Entra ID / Azure AD) SSO，包括在 Azure Portal
  创建应用和设置环境变量。
tags:
  - Microsoft
  - 身份验证
...
<Steps>
  ...
  <Image alt="应用注册" inStep src="https://github.com/Hubstr-code/app/assets/13883964/4f9d83bd-b3fc-4abc-bcf4-ccbad65c219d" />
  ...
  <Image alt="应用概览" inStep src="https://github.com/Hubstr-code/app/assets/13883964/48a0b702-05bd-4ce4-a007-a8ad00a36e5a" />
  ...
  <Image alt="创建客户端密钥" inStep src="https://github.com/Hubstr-code/app/assets/13883964/c9d66fa0-158c-4bd3-a1fa-969e638259d2" />
...
<Callout type={'info'}>
  部署成功后，用户将可以通过 Microsoft 身份认证并使用 Hubstr。
</Callout>
