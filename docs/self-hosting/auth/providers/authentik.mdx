---
title: Configuring Authentik Authentication for Hubstr
description: >-
  Learn how to configure Authentik SSO for Hubstr, including creating an OAuth2
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`    | Required | SSO provider for Hubstr. Use `authentik` for Authentik                       |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authentik and use Hubstr.
</Callout>
