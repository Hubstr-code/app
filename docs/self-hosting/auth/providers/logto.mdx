---
title: Configuring Logto Authentication for Hubstr
description: >-
  Learn how to configure Logto SSO for Hubstr, including creating an
...
<Steps>
  ...
  4. Fill in the application name: `Hubstr`
  ...
  | `AUTH_SSO_PROVIDERS`        | Required | SSO provider for Hubstr. Use `logto` for Logto                               |
  ...
  Configure Logto [Webhook](https://docs.logto.io/developers/webhooks/configure-webhooks) to sync user data updates to Hubstr.
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Logto and use Hubstr.
</Callout>
