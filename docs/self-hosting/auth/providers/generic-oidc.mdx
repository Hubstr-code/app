---
title: Configuring Generic OIDC Authentication for Hubstr
description: >-
  Learn how to configure any OpenID Connect provider for Hubstr using Generic
  OIDC integration.
tags:
  - Generic OIDC
  - OpenID Connect
...
Use Generic OIDC to integrate Hubstr with any OpenID Connect compliant identity provider not explicitly listed in our supported providers.
