---
title: Configuring Okta Authentication for Hubstr
description: >-
  Learn how to configure Okta SSO for Hubstr, including creating an application
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS` | Required | SSO provider for Hubstr. Use `okta` for Okta                                 |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Okta and use Hubstr.
</Callout>
