---
title: Configuring AWS Cognito Authentication for Hubstr
description: >-
  Learn how to configure AWS Cognito SSO for Hubstr, including creating a User
