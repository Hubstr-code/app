---
title: Configuring Cloudflare Zero Trust Authentication for Hubstr
description: >-
  Learn how to configure Cloudflare Zero Trust SSO for Hubstr, including
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`                | Required | SSO provider for Hubstr. Use `cloudflare-zero-trust`                         |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Cloudflare Zero Trust and use Hubstr.
</Callout>
