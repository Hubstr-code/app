---
title: Configuring Authelia Authentication for Hubstr
description: >-
  Learn how to configure Authelia SSO for Hubstr, including setting up OIDC
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`   | Required | SSO provider for Hubstr. Use `authelia` for Authelia                         |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authelia and use Hubstr.
</Callout>
