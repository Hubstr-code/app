---
title: Configuring ZITADEL Authentication for Hubstr
description: >-
  Learn how to configure ZITADEL SSO for Hubstr, including creating an
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`  | Required | SSO provider for Hubstr. Use `zitadel` for ZITADEL                           |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with ZITADEL and use Hubstr.
</Callout>
