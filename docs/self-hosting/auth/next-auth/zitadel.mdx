---
title: Configure ZITADEL Authentication Service for Hubstr
description: >-
  Learn how to configure ZITADEL Authentication Service for Hubstr deployment,
...
<Steps>
  ...
  <Callout type={'important'}>
    ...
    - Replace `http(s)://your-domain` with the actual URL that Hubstr is deployed to.
  </Callout>
...
<Callout>
  After successful deployment, users will be able to authenticate and use Hubstr using existing
