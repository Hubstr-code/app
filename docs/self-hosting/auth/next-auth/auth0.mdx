---
title: Configure Auth0 Identity Verification Service for Hubstr
description: >-
  Learn how to configure Auth0 Identity Verification Service for Hubstr for
...
<Steps>
  ...
  Click on the "Users Management" in the left navigation bar to enter the user management interface, where you can create users for your organization to log in to Hubstr.
...
<Callout type={'warning'}>
  ...
  Hubstr being abused by external users.
</Callout>
