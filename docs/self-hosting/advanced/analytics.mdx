---
title: Integrating Data Analytics Services in Hubstr for User Usage Analysis
description: >-
  Learn how to integrate free/open-source data analytics services in Hubstr to
...
To better help analyze the usage of Hubstr users, we have integrated several free/open-source data analytics services in Hubstr for collecting user usage data, which you can enable as needed.
