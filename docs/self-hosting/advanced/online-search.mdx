...
title: >-
  ...
  Information
description: >-
  Learn how to configure the SearXNG online search functionality for Hubstr,
...
When enabled, Hubstr replaces the Jina endpoints as follows:
...
You can find publicly available SearXNG instances in the [SearXNG instance list](https://searx.space/). Choose an instance that is fast and reliable, and then configure its URL in Hubstr.
...
- [Hubstr Online Search RFC Discussion](https://github.com/Hubstr-code/app/discussions/6447)
