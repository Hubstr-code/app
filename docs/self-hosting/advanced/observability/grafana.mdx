...
description: >-
  Monitor and analyze your Hubstr instance using Grafana dashboards, Prometheus
...
Hubstr supports advanced observability for self-hosted deployments using open-source tools:
...
This guide will help you set up and use these tools to monitor your Hubstr instance.
...
```bash
curl -O https://raw.githubusercontent.com/Hubstr-code/app/HEAD/docker-compose/production/grafana/docker-compose.yml
curl -O https://raw.githubusercontent.com/Hubstr-code/app/HEAD/docker-compose/production/grafana/.env.example
mv .env.example .env
```
...
2. Start the stack with the correct profile:
   ...
   This will launch Grafana, Prometheus, Tempo, and the otel-collector alongside Hubstr with Casdoor, Minio, and other advanced services.
...
- Verify Prometheus and Tempo are scraping and receiving data from Hubstr and otel-collector.

## See Also

- [Langfuse Observability](https://hubstr.com/docs/self-hosting/advanced/observability/langfuse)
- [Self-Hosting Overview](https://hubstr.com/docs/self-hosting/start)
