---
title: Automatic Synchronization with Hubstr Desktop
description: Configure Hubstr Desktop for a synchronized experience
tags:
  - Hubstr
...
# Automatic Synchronization with Hubstr Desktop

Hubstr Desktop provides users with an enhanced experience while also expanding the capabilities of Hubstr, allowing users to utilize Hubstr in offline environments. This document will guide you on how to configure Hubstr Desktop and connect it to your self-hosted instance.

## System Requirements

Hubstr Desktop is built using Electron and supports the following operating systems:
...
The version release of Hubstr Desktop follows this logic:

- **Beta Version**: All merges to the main branch that are automatically released will be created as Beta versions of Hubstr Desktop.
...
Hubstr Desktop can connect to your self-hosted Hubstr instance, allowing you to use your self-hosted configuration on the desktop.
...
If you are deploying Hubstr using one-click deployment methods (such as Vercel, Railway, etc.), you need to:
...
1. Open Hubstr Desktop.
2. Click the Wi-Fi icon in the upper right corner.
3. Enter the address of your self-hosted instance (e.g., `https://your-Hubstr-instance.com`).
...
- Example file names:
  - Apple Silicon: `Hubstr-Beta-1.83.6-arm64.dmg` or `Hubstr-Beta-1.83.6-arm64-mac.zip`
  - Intel: `Hubstr-Beta-1.83.6-x64.dmg` or `Hubstr-Beta-1.83.6-mac.zip`
