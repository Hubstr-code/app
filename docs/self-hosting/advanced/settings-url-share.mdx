...
description: >-
  Learn how to import and export configuration settings for Hubstr via URL.
...
Hubstr support import settings from external URL to quickly set up Hubstr configuration.
...
```plaintext
https://hubstr.com/?settings=<settings object in JSON format>
https://hubstr.com/?settings={"keyVaults":{"openai":{"apiKey":"user-key","baseURL":"https://your-proxy.com/v1"}}}
```
...
<Callout type={'warning'}>
  Hubstr does not verify the correctness of the settings parameters in the URL, nor provide
