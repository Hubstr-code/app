...
description: >-
  Explore the architecture of Hubstr, an open-source AI Agent platform built on
...
Hubstr is an open-source AI Agent platform built on Next.js, enabling users to interact with AI through natural language, use tools, manage knowledge bases, and more. The following is an overview of Hubstr's architecture design.

## Application Architecture Overview

The overall architecture of Hubstr consists of the following core layers:
...
Hubstr uses [Better Auth](https://www.better-auth.com/) as the authentication framework, supporting:
