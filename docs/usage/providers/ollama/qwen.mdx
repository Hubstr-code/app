---
title: Using the Local Qwen Model in Hubstr
description: >-
  Easily chat with the locally deployed Qwen model through Hubstr's integration
...
<Image alt={'Using Qwen in Hubstr'} cover src={'/blog/assets17870709/b4a01219-e7b1-48a0-888c-f0271b18e3a6.webp'} />
...
Now, thanks to Hubstr’s integration with [Ollama](https://ollama.com/), you can easily use the Qwen model locally within Hubstr.

This guide will walk you through how to use the locally deployed Qwen model in Hubstr:
...
You’re now ready to start chatting with the local Qwen model in Hubstr.
