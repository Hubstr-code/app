---
title: Using Jina AI API Key in Hubstr
description: >-
  Learn how to configure and use Jina AI models in Hubstr, obtain your API key,
  and start chatting.
tags:
  - Hubstr
  - Jina AI
...
# Using Jina AI in Hubstr

<Image alt={'Using Jina AI in Hubstr'} cover src={'/blog/assetsc6ff27b7134f280727e1fd7ff83ed2fa.webp'} />
...
This guide will walk you through how to use Jina AI in Hubstr:
...
<Steps>
  ...
  ### Step 2: Configure Jina AI in Hubstr
...
And that’s it! You’re now ready to start chatting with models powered by Jina AI in Hubstr.
