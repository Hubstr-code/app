---
title: Using SenseTime SenseNova in Hubstr
description: >-
  Learn how to configure and use your SenseTime SenseNova API Key in Hubstr to
...
# Using SenseTime SenseNova in Hubstr
...
This guide will walk you through how to use SenseNova within Hubstr.
...
<Steps>
  ...
  ### Step 2: Configure SenseNova in Hubstr
...
And that’s it! You’re now ready to use SenseTime SenseNova models in Hubstr for intelligent conversations.
