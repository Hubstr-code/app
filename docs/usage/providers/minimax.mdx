---
title: Using the Minimax API Key in Hubstr
description: >-
  Learn how to configure and use the MiniMax AI model in Hubstr. This guide
...
# Using Minimax in Hubstr

<Image alt={'Using Minimax in Hubstr'} cover src={'/blog/assets34400653/703f170b-c03b-4c71-b57d-c2357596bdfb.webp'} />
...
This guide will walk you through how to use MiniMax in Hubstr:
...
<Steps>
  ...
  ### Step 2: Configure MiniMax in Hubstr
...
You're all set! You can now start chatting with models powered by MiniMax in Hubstr.
