---
title: Using Tencent Cloud API Key in Hubstr
description: >-
  Learn how to configure and use Tencent Cloud AI models in Hubstr, obtain your
...
# Using Tencent Cloud in Hubstr

<Image alt={'Using Tencent Cloud in Hubstr'} cover src={'/blog/assetsf625540e8340bafe69ccbb89ad75707a.webp'} />
...
This guide will walk you through how to integrate Tencent Cloud's AI models into Hubstr:
...
<Steps>
  ...
  ### Step 2: Configure Tencent Cloud in Hubstr

  - Open Hubstr and go to App Settings > AI Service Providers.
...
That's it! You’re now ready to use Tencent Cloud’s AI models in Hubstr for conversations.
