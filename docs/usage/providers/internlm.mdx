---
title: Using InternLM in Hubstr
description: >-
  Learn how to configure and use your InternLM API Key in Hubstr to start
...
This guide will walk you through how to use InternLM within Hubstr.
...
<Steps>
  ...
  ### Step 2: Configure InternLM in Hubstr
...
You’re all set! You can now start using InternLM-powered models in Hubstr for conversations and interactions.
