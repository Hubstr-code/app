---
title: Using Infini-AI in Hubstr
description: >-
  Learn how to configure and use Infini-AI's API Key in Hubstr to enable
...
This guide will walk you through the steps to quickly integrate Infini-AI's capabilities into Hubstr.
...
<Steps>
  ...
  ### Step 2: Configure the Model Service in Hubstr

  - Open Hubstr and go to the "Settings" page
