---
title: Using vLLM API Key in Hubstr
description: >-
  Learn how to configure and use vLLM language models in Hubstr, obtain an API
...
# Using vLLM in Hubstr

<Image alt={'Using vLLM in Hubstr'} cover src={'/blog/assets1049abec5850cebf8ce12cd50199b9c5.webp'} />
...
This guide will walk you through how to use vLLM in Hubstr:
...
<Steps>
  ...
  ### Step 4: Configure vLLM in Hubstr

  - Open the `App Settings` panel in Hubstr
...
You're now ready to use vLLM-powered models in Hubstr for conversations.
