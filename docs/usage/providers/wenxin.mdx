---
title: Using Wenxin Qianfan in Hubstr
description: >-
  Learn how to configure and use the Wenxin Qianfan API Key in Hubstr to start
...
# Using Wenxin Qianfan in Hubstr
...
This guide will walk you through how to use Wenxin Qianfan in Hubstr.
...
<Steps>
  ...
  ### Step 2: Configure Wenxin Qianfan in Hubstr
...
Now you're all set to start using Wenxin Qianfan models for conversations in Hubstr.
