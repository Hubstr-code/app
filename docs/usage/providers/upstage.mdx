---
title: Using Upstage in Hubstr
description: >-
  Learn how to configure and use Upstage's API Key in Hubstr to start
...
This guide will walk you through how to use Upstage within Hubstr.
...
<Steps>
  ...
  ### Step 2: Configure Upstage in Hubstr
...
And that’s it! You’re now ready to use Upstage’s models for conversations in Hubstr.
