---
title: Using Volcengine API Key in Hubstr
description: >-
  Learn how to configure and use Volcengine AI models in Hubstr, obtain your
...
# Using Volcengine in Hubstr

<Image alt={'Using Volcengine in Hubstr'} cover src={'/blog/assets80a8b9627374fc345f4bf8e3adf11074.webp'} />
...
This guide will walk you through how to use Volcengine in Hubstr:
...
<Steps>
  ...
  ### Step 2: Configure Volcengine in Hubstr

  - Open the `App Settings` in Hubstr and go to the `AI Service Providers` section
...
You're now ready to start chatting with models powered by Volcengine in Hubstr.
