---
title: Using Tongyi Qianwen API Key in Hubstr
description: >-
  Learn how to configure and use Alibaba Cloud's Tongyi Qianwen model in
  Hubstr, offering powerful natural language understanding and generation
  capabilities.
tags:
  - Hubstr
  - Tongyi Qianwen
...
# Using Tongyi Qianwen in Hubstr

<Image alt={'Using Tongyi Qianwen in Hubstr'} cover src={'/blog/assets34400653/4e057b43-1e3e-4e96-a948-7cdbff303dcb.webp'} />
...
This guide will walk you through how to use Tongyi Qianwen in Hubstr:
...
<Steps>
  ...
  ### Step 3: Configure Tongyi Qianwen in Hubstr
...
You’re all set! You can now start using Tongyi Qianwen’s models in Hubstr for intelligent conversations.
