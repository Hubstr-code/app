---
title: Using the SambaNova API Key in Hubstr
description: >-
  Learn how to configure and use SambaNova models in Hubstr, obtain your API
...
# Using SambaNova in Hubstr

<Image alt={'Using SambaNova in Hubstr'} cover src={'/blog/assetsd9e6fe2197270f0f774accd6abcf4019.webp'} />
...
This guide will walk you through how to use SambaNova in Hubstr:
...
<Steps>
  ...
  ### Step 2: Configure SambaNova in Hubstr

  - Go to the `App Settings` section in Hubstr
...
You're now ready to start chatting with models powered by SambaNova in Hubstr.
