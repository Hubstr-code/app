---
title: Using the Stepfun API Key in Hubstr
description: >-
  Learn how to configure and use Stepfun's AI models in Hubstr, including how
...
# Using Stepfun in Hubstr

<Image alt={'Using Stepfun in Hubstr'} cover src={'/blog/assets34400653/95717e2b-1a55-4fca-a96b-b1c186ed4563.webp'} />
...
This guide will walk you through how to use Stepfun in Hubstr:
...
<Steps>
  ...
  ### Step 2: Configure Stepfun in Hubstr
...
And that’s it! You’re now ready to start chatting with AI models powered by Stepfun in Hubstr.
