---
title: Using Fireworks AI in Hubstr
description: >-
  Learn how to configure and use Fireworks AI's API Key in Hubstr to start
...
This guide will walk you through how to use Fireworks AI within Hubstr.
...
<Steps>
  ...
  ### Step 2: Configure Fireworks AI in Hubstr
...
And that’s it! You’re now ready to start using Fireworks AI models in Hubstr for conversations and interactions.
