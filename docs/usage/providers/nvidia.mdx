---
title: Using Nvidia NIM API Key in Hubstr
description: >-
  Learn how to configure and use Nvidia NIM AI models in Hubstr, obtain your
...
# Using Nvidia NIM in Hubstr

<Image alt={'Using Nvidia NIM in Hubstr'} cover src={'/blog/assetsd8927338578c426b833e5cb57e0b57ec.webp'} />
...
This guide will walk you through how to integrate and use AI models provided by Nvidia NIM in Hubstr:
...
<Steps>
  ...
  ### Step 2: Configure Nvidia NIM in Hubstr

  - Go to the `App Settings` section in Hubstr and navigate to `AI Service Providers`.
...
That’s it! You’re now ready to use Nvidia NIM-powered models in Hubstr for your conversations.
