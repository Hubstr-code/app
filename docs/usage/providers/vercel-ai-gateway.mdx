---
title: Using Vercel AI Gateway in Hubstr
description: Learn how to integrate and use the unified API of Vercel AI Gateway in Hubstr
tags:
  - Hubstr
  - Vercel AI Gateway
  - API Key
...
# Using Vercel AI Gateway in Hubstr
...
This guide will walk you through how to use Vercel AI Gateway within Hubstr.
...
<Steps>
  ...
  ### Step 2: Configure Vercel AI Gateway in Hubstr
...
That's it! You can now start chatting in Hubstr using models provided by Vercel AI Gateway.
