---
title: Using iFLYTEK Spark in Hubstr
description: >-
  Learn how to configure and use the iFLYTEK Spark API Key in Hubstr to start
...
This guide will walk you through how to use iFLYTEK Spark in Hubstr.
...
<Steps>
  ...
  ### Step 2: Configure iFLYTEK Spark in Hubstr
...
That's it! You're now ready to use iFLYTEK Spark's models for conversations in Hubstr.
