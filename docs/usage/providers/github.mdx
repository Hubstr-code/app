---
title: Using GitHub Models in Hubstr
description: >-
  Learn how to configure and use GitHub's API Key in Hubstr to start
...
This guide will walk you through how to use GitHub Models within Hubstr.
...
<Steps>
  ...
  ### Step 2: Configure GitHub Models in Hubstr
...
And that’s it! You’re now ready to start using GitHub-provided models in Hubstr for conversations and interactions.
