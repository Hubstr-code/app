...
<AccordionGroup>
  <Accordion title="Built-in Skills">
    Pre-installed skills that ship with Hubstr:
    ...
    Built-in skills are maintained by the Hubstr team and automatically updated.
  </Accordion>

  <Accordion title="Market Skills">
    Community-created skills available from the Hubstr marketplace:
...
Hubstr includes several powerful built-in tools:
...
Extend agent capabilities with plugins from the Hubstr marketplace:
...
MCP is Hubstr's system for connecting agents to external tools and services — databases, APIs, file systems, development tools, and business applications.
