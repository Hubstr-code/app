...
| ------------------------ | ------------------------------------ | ----------------------------------------- |
| **Built-in tools**       | Capabilities built into Hubstr      | Artifacts, Sandbox, GTD, Notebook, Memory |
| **Hubstr Integrations** | OAuth-connected third-party services | Linear, Microsoft, Twitter                |
...
- **Hubstr** — Built-in tools and Hubstr-native integrations (Linear, Microsoft, Twitter, Composio services)
...
Built-in tools (Artifacts, Sandbox, GTD, Notebook) are pre-installed — you can enable them for any Agent immediately. Hubstr Integrations and Composio services require an OAuth connection:

1. In the Skill Store, go to the **Hubstr** tab
...
**Integrations** — Built-in tools, Hubstr-connected services, and Composio integrations. Each shows its connection status. Click **Connect** or **Disconnect** to manage the OAuth link.
