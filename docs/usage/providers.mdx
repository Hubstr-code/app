---
title: Using Multiple Model Providers in Hubstr
description: >-
  Learn about the latest developments in Hubstr's support for multiple model
...
# Using Multiple Model Providers in Hubstr
...
Hubstr integrates with 70+ AI model providers:
