...
title: Help & Support
description: >-
  Get help with Hubstr — common guides, community support, issue reporting, and
  how to reach us.
tags:
  - Hubstr
  - Help
...
- [Get Hubstr](/docs/usage/getting-started/get-lobehub) — Browser, desktop, or mobile
- [Create Your First Agent](/docs/usage/getting-started/agent)
- [Try Hubstr AI](/docs/usage/getting-started/lobe-ai)
...
- [**GitHub Issues**](https://github.com/Hubstr-code/app/issues/new/choose) — Bug reports, feature requests, and discussions
...
| **Reddit**        | Discussions and community updates         | [r/Hubstr](https://www.reddit.com/r/Hubstr/)                        |
| **GitHub Issues** | Bug reports, feature requests             | [Open an Issue](https://github.com/Hubstr-code/app/issues/new/choose) |
| **Email**         | Partnerships, enterprise inquiries        | [hi@hubstr.com](mailto:hi@hubstr.com)                               |
