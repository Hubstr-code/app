---
title: 帮助与支持
description: 获取 Hubstr 帮助——常用指南、社区支持、问题反馈及联系方式。
tags:
  - Hubstr
  - 帮助
  - 支持
...
- [获取 Hubstr](/zh/docs/usage/getting-started/get-lobehub) — 浏览器、桌面端或移动端
- [创建你的第一个助理](/zh/docs/usage/getting-started/agent)
- [体验 Hubstr AI](/zh/docs/usage/getting-started/lobe-ai)
...
- [**GitHub Issues**](https://github.com/Hubstr-code/app/issues/new/choose) — Bug 反馈、功能建议与讨论
...
| **Reddit**        | 讨论与社区动态      | [r/Hubstr](https://www.reddit.com/r/Hubstr/)                   |
| **GitHub Issues** | Bug 反馈、功能建议  | [提交 Issue](https://github.com/Hubstr-code/app/issues/new/choose) |
| **邮箱**            | 合作、企业咨询      | [hi@hubstr.com](mailto:hi@hubstr.com)                          |
