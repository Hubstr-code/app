...
function updatePackageJson() {
  ...
  try {
    ...
    switch (releaseType) {
      case 'stable': {
        packageJson.productName = 'Hubstr';
        packageJson.name = 'hubstr-desktop';
        console.log('🌟 Setting as Stable version.');
        break;
      }
      case 'beta': {
        packageJson.productName = 'Hubstr-Beta'; // Or 'Hubstr-Beta' if preferred
        packageJson.name = 'hubstr-desktop-beta'; // Or 'hubstr-desktop' if preferred
        console.log('🧪 Setting as Beta version.');
        updateAppIcon('beta');
        break;
      }
      case 'nightly': {
        packageJson.productName = 'Hubstr-Nightly'; // Or 'Hubstr-Nightly'
        packageJson.name = 'hubstr-desktop-nightly'; // Or 'hubstr-desktop-nightly'
      ...
      case 'canary': {
        packageJson.productName = 'Hubstr';
        packageJson.name = 'hubstr-desktop-canary';
