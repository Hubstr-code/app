...
export const buildTaskManagerDefaultsBlock = ({
  ...
  return [
    ...
    `Default Hubstr AI agent id: ${defaultAssigneeAgentId}`,
    'Use this id as assigneeAgentId when you decide a task should be assigned to the default Hubstr AI assistant.',
    "Do not use it as a listTasks filter unless the user asks for Hubstr AI's tasks.",
    '</task_manager_defaults>',
    '',
  ];
};
