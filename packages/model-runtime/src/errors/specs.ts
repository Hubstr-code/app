 ...
 * because they're emitted solely by the managed Hubstr Cloud gateway. They're
...
export type CloudErrorCode =
  ...
  | typeof ChatErrorType.HubstrModelDeprecated;
...
export const ERROR_CODE_SPECS: SpecMap = {
  ...
  [ChatErrorType.FreePlanLimit]: {
    ...
    retryable: false,
    countAsFailure: false,
    description: 'Hubstr Cloud free-plan usage limit reached.',
  },
  [ChatErrorType.InsufficientBudgetForModel]: {
    ...
    retryable: false,
    countAsFailure: false,
    description: 'Hubstr Cloud balance is positive but below the model’s estimated cost.',
  },
  ...
  // —— Cloud-only (tier 9) ——
  [ChatErrorType.HubstrModelDeprecated]: {
    code: ChatErrorType.HubstrModelDeprecated,
    numericId: 4901,
    category: 'request',
    severity: 'warning',
    attribution: 'user',
    ...
    retryable: false,
    countAsFailure: false,
    description: 'Requested Hubstr Cloud model has been deprecated / removed.',
  },
