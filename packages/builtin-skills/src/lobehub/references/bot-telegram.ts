...
- **Secret Token** (optional): a custom string you define; Hubstr includes it in webhook requests so you can verify they genuinely come from Hubstr — leave blank unless you have a security requirement
