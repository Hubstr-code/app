export default {
  ...
  'heteroAgent.executionTarget.infoTooltip':
    'Pick a device and the agent uses it as its runtime environment — reading and writing files and operating the computer. Cloud sandbox is provided by Hubstr Marketplace.',
  ...
  'claudeCodeInstallGuide.reason': 'Hubstr could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': 'Hubstr could not start Codex: {{message}}',
  ...
  'gatewayMode.desc':
    "Run agents in the cloud through Hubstr's Agent Gateway. Tasks keep running even after you close the page.",
  ...
  'plus.search.appSearchDesc':
    'Hubstr optimized search service, delivering best retrieval results.',
  ...
  'sharePage.menu.goToHubstr': 'Go to Hubstr',
  'sharePage.menu.more': 'More',
  'sharePage.menu.report': 'Report',
  'sharePageDisclaimer':
    "Shared by a user. The content reflects their views, not Hubstr's, and Hubstr takes no responsibility for it.",
