export default {
  ...
  'protocolInstall.official.badge': 'Hubstr Official Skill',
  'protocolInstall.official.description': 'Official Hubstr Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. Hubstr does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
