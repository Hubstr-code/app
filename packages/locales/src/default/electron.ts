export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote Hubstr server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'Hubstr Cloud',
