export default {
  ...
  'createGuide.func1.title': 'Submit in Hubstr',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Hubstr Community.',
  'footer.title': 'Share your creation on Hubstr Community today',
  ...
  'models.providerInfo.apiTooltip': 'Hubstr supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Hubstr Official Service',
  ...
  'skills.details.sidebar.agent.useOnLobeAI': 'Use on Hubstr AI',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by Hubstr automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the Hubstr marketplace with one click.',
