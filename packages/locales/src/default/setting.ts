export default {
  ...
  'devices.connectWizard.cli.installDesc':
    'Install the Hubstr CLI globally with your preferred package manager to enable device connectivity and management.',
  ...
  'devices.connectWizard.desktop.downloadLink': 'Download Hubstr Desktop',
  'devices.connectWizard.desktop.step1': 'Download the desktop app',
  'devices.connectWizard.desktop.step1Desc':
    'Visit the Hubstr downloads page and get the app for your operating system.',
  ...
  'devices.connectWizard.subtitle': 'Choose how to connect your computer to Hubstr.',
  'devices.connectWizard.title': 'Connect Device',
  'devices.empty.desc':
    'Once connected, Hubstr agents can read/write files, run commands, and call system tools directly on your computer.',
  ...
  'memory.enabled.desc':
    'Allow Hubstr to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
  ...
  'notification.push.desc':
    'Send push notifications to your mobile devices (Hubstr mobile app required)',
  ...
  'settingAppearance.appTray.desc':
    'Show the Hubstr icon in the system tray or macOS menu bar. Disabling it also removes tray menu access.',
  ...
  'settingSystemTools.tools.lobehub.desc': 'Hubstr CLI - manage and connect to Hubstr services',
  ...
  'skillStore.tabs.lobehub': 'Hubstr',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'storage.actions.transfer.desc':
    'Move agents and their data to another Workspace or your personal account. The originals leave the current space. Hubstr AI cannot be moved; copy it instead.',
  ...
  'workspace.general.copyLobeAI.modal.defaultInboxTitle': 'Hubstr AI',
  ...
  'workspace.onboarding.skipConfirm.description':
    'You can always customize Hubstr AI and add agents later in Workspace settings.',
  ...
  'workspace.onboarding.step1.heading': 'Personalize Hubstr AI',
  ...
  'workspace.onboarding.step1.nameLabel': "Hubstr AI's name",
  'workspace.onboarding.step1.namePlaceholder': 'e.g. Hubstr AI',
  ...
  'workspace.onboarding.step1.footer':
    "Set up your workspace's Hubstr AI assistant — it learns from every conversation and grows into your team's go-to teammate.",
  ...
  'tools.builtins.lobe-skill-store.description':
    'Browse and install agent skills from the Hubstr marketplace. Use this when you need extended capabilities or want to install a specific skill.',
  ...
  'tools.builtins.lobehub.description':
    'Manage the Hubstr platform via CLI — knowledge bases, memory, agents, files, search, generation, and more.',
  'tools.builtins.lobehub.title': 'Hubstr',
