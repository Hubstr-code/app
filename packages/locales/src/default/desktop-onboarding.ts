export default {
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Hubstr. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve Hubstr',
  ...
  'screen5.actions.signInCloud': 'Sign in to Hubstr Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Hubstr Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Hubstr Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Hubstr server instance',
