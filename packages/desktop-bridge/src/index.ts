 ...
 * originates from the Market service's own OAuth token, NOT from the user's Hubstr
 * session.  responseMeta checks this to suppress the X-Auth-Required header so the
 * desktop "re-login to Hubstr" modal is NOT shown; the Market OAuth flow handles it
